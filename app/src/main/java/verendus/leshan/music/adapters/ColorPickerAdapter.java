...
public class ColorPickerAdapter extends RecyclerView.Adapter<ColorPickerAdapter.ColorPickerViewHolder> {
    ...
    public static class ColorPickerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ColorPickerViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(ColorPickerViewHolder.this);
    ...
    public ColorPickerAdapter(Context c, ArrayList<Playlist> playlists) {
    ...
    public ColorPickerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ColorPickerViewHolder colorPickerViewHolder = new ColorPickerViewHolder(linearLayout);
